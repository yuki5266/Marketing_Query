DROP PROCEDURE IF EXISTS reporting_cf.SP_campaign_list_gen_PA2_CF;
CREATE PROCEDURE reporting_cf.`SP_campaign_list_gen_PA2_CF`()
BEGIN
/*********************************************************************************************************************************
---    NAME : SP_campaign_list_gen_PA2_CF
...
************************************************************************************************************************************/
  ...
  SET @process_name = 'SP_campaign_list_gen_PA2_CF', @status_flag_success = 1, @status_flag_failure = 0;
