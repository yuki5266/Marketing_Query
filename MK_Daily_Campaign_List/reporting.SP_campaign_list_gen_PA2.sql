DROP PROCEDURE IF EXISTS reporting.SP_campaign_list_gen_PA2;
CREATE PROCEDURE reporting.`SP_campaign_list_gen_PA2`()
BEGIN
/*********************************************************************************************************************************
---    NAME : SP_campaign_list_gen_PA2
...
---    03/12/2017    Eric Pu         migrate it to reportingn schema
