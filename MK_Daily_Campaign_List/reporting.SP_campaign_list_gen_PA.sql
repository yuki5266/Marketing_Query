DROP PROCEDURE IF EXISTS reporting.SP_campaign_list_gen_PA;
CREATE PROCEDURE reporting.`SP_campaign_list_gen_PA`()
BEGIN
/*********************************************************************************************************************************
---    NAME : SP_campaign_list_gen_PA
...
---    23/06/2017    Eric Pu 				 DAT-129 update SPs for new product: CA PayDay Loans
