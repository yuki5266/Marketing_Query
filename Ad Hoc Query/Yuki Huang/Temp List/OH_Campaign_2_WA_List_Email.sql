...
Audience 1: Withdrawn customers with the eligible withdrawn reasons. since when 2015, 
   ...
   -- select * from raw2;
      ...
      IF(r2.lms_code = 'JAG',
       ...
       (CASE
        ...
        END)) as cell_phone
      from raw1 r1
      inner join raw2 r2 on r1.lms_code=r2.lms_code and r1.lms_customer_id=r2.lms_customer_id and r1.received_time=r2.last_received_time
      left JOIN jaglms.lms_customer_info_flat ff ON r2.lms_customer_id = ff.customer_id AND r2.lms_code = 'JAG'
      left JOIN ais.vw_client tt ON r2.lms_customer_id = tt.id AND r2.lms_code = 'EPIC');
